...
# products
select_products = "SELECT * FROM products ORDER BY product_id ASC LIMIT 5;"
...
# sales
select_sales = "SELECT * FROM sales ORDER BY order_id ASC LIMIT 5;"
...
# sellers
select_sellers = "SELECT * FROM sellers ORDER BY seller_id ASC LIMIT 5;"
